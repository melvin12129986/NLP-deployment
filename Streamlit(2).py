...
div[data-testid="metric-container"] [data-testid="metric-value"] { font-size: 22px !important; font-weight: 600 !important; color: #000 !important; }
...
def predict_disease(input_text, svm_model, vectorizer, stop_words, stemmer):
    if not input_text.strip():
        return None
    cleaned = clean_text(input_text, stop_words, stemmer)
    if not cleaned:
        return None
    try:
